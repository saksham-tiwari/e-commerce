...
const NavBar = () => {
    return (
        <div>
            <Navbar bg="light" expand="lg" className="color-nav navibar">
              <Container fluid>
                ...
                <Navbar.Collapse id="navbarScroll">
                  ...
                  <Link to="/login" className="nav-link"><Button variant="primary" className="login-button">Log In</Button></Link>  
                  <Nav.Link><Link to="/cart" className="nav-link"><img src={bag} alt="bag"/></Link></Nav.Link>
          ...
          <Navbar bg="light" expand="lg" className="color-nav navbar navbar-default navbar-static-top">
              <Container fluid>
                <Navbar.Brand href="#">Navbar scroll</Navbar.Brand>
